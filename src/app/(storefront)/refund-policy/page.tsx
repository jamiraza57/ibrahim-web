...
export default function RefundPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <h1 className="mb-8 font-serif text-3xl text-white sm:text-4xl">Refund Policy</h1>

      <div className="space-y-6 text-sm text-secondary-text">
        <p>Last updated: {new Date().getFullYear()}</p>

        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Returns</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Non-Returnable Items</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Refund Process</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Damaged or Incorrect Items</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Exchanges</h2>
          <p>
