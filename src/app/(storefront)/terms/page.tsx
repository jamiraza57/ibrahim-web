...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <h1 className="mb-8 font-serif text-3xl text-white sm:text-4xl">Terms of Service</h1>

      <div className="space-y-6 text-sm text-secondary-text">
        <p>Last updated: {new Date().getFullYear()}</p>

        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Orders</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Product Descriptions</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Cancellations</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Limitation of Liability</h2>
          <p>
