...
export default function ShippingPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <h1 className="mb-8 font-serif text-3xl text-white sm:text-4xl">Shipping Policy</h1>

      <div className="space-y-6 text-sm text-secondary-text">
        <p>Last updated: {new Date().getFullYear()}</p>

        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Processing Time</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Delivery Time</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Shipping Charges</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Cash on Delivery</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Packaging</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-serif text-lg text-white">Order Issues</h2>
          <p>
